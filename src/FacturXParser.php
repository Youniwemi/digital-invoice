...
/**
 * Reads FacturX / ZUGFeRD 2.1.1 / XRechnung XML (Cross Industry Invoice format).
 *
 * Uses easybill/zugferd-php ZUGFeRD211 Reader which deserializes via JMS Serializer
 * into the same CrossIndustryInvoice object graph used by FacturX.php for writing.
 */
class FacturXParser extends XmlParser
{
